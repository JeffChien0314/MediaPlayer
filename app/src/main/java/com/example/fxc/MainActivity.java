            ...
            switch (message.what) {
                ...
                case UPDATE_DEVICE_LIST:
                    ...
                    if (externalDeviceInfos.size()==0){
                        ...
                        if (MediaDeviceManager.getInstance().getCurrentDevice()!=null && MediaDeviceManager.getInstance().ifExsitThisDevice(getApplicationContext(), MediaDeviceManager.getInstance().getCurrentDevice())){//currentDeviceInfo即当前文件列表对应的设备，设备还在，无需更新文件列表
