...
package com.example.fxc.service.contentcatalogs;
...
import com.example.fxc.mediaplayer.BuildConfig;
 ...
 */
    ...
    public static List<MediaBrowserCompat.MediaItem> getMediaItems(String path) {
        List<MediaBrowserCompat.MediaItem> result = new ArrayList<>();
        //获取当前path下文件内容
